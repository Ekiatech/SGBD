...
";
	...
	echo "Donn&eacute;es ajout&eacute;es <br>";
...
?>
       ...
       <div>
              <input type="button" class = 'button' onclick="window.location.href = 'https://cdeplanne001.vvvpedago.enseirb-matmeca.fr/tmp/creation_trigger.php';" value="Continuer"/> 
       </div>
