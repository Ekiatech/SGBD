...
/** MOYENNE DES DISTANCES PARCOURUES PAR LES VELOS SUR UNE SEMAINE **/
DELIMITER |
...
/** ============================================== 
                    ...
                    PROCEDURES PEUPLEMENT

    ============================================== **/

/** AJOUT DEBUT UTILISATION PEUPLEMENT**/
DELIMITER |
CREATE PROCEDURE ajout_debut_utilisation_peuplement(IN p_id_velo INT, IN p_id_adherent INT, IN p_date_debut DATETIME)
BEGIN
        SELECT id_station INTO @p_id_station FROM velos WHERE id_velo = p_id_velo;
        INSERT INTO utilisations(id_velo, id_adherent, id_station_debut, date_debut, kilometrage_parcouru)
        VALUES
...
/** AJOUT FIN UTILISATION PEUPLEMENT **/
DELIMITER |
CREATE PROCEDURE ajout_fin_utilisation_peuplement(IN p_id_adherent INT, IN p_id_station_fin INT,  IN p_date_fin DATETIME)
BEGIN
